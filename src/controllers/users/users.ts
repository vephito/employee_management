...
export class UserController{
    ...
    getAllUser = async(req:Request, res:Response) => {
        try{
            ...
            const paginatedCacheResults = await this.db.getAll(page,limit)
    ...
    async updateUser(req:Request,res:Response){
        try{
            ...
            const user = await this.db.getOneUser(id)
            if (user){
                await this.dbs.createOne('users',id,user)
            }
    ...
    async createUser(req:Request,res:Response){
        try{
            ...
            await createQueue.add('create-queue',data)
